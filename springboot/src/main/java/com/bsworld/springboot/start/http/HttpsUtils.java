...
public class HttpsUtils {
    ...
    private static int connectionTimeout = 5000;// 连接超时时间,毫秒
    private static int soTimeout = 500;// 读取数据超时时间，毫秒
...
//            .evictIdleConnections(1, TimeUnit.SECONDS).build();
  /*  private static CloseableHttpClient httpclient = HttpClients.
    ...
    /*private static CloseableHttpClient httpclient = HttpClients.
            custom().disableCookieManagement().setMaxConnPerRoute(100).setMaxConnPerRoute(50).disableAutomaticRetries().build();*/
    /*** 超时设置 ****/
